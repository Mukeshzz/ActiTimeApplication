...
public class DataUtility {
	public String getDataFromProperties(String key) throws IOException {
		FileInputStream fis=new FileInputStream("C:\\Users\\Mukesh\\Documents\\Selenium\\commondata.properties");
	...
	public String getDataFromExcelSheet(String sheetname,int rownum,int cellnum) throws EncryptedDocumentException, IOException {
		FileInputStream fis=new FileInputStream("C:\\Users\\Mukesh\\Documents\\Selenium\\Book1.xlsx");
